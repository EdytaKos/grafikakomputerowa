...
public class Lab6 extends GLJPanel implements GLEventListener  {
    ...
    public void Figura(GL2 gl2, int n, int r, int h) {
        ...
        for (int i=0;i<=n;i++)
        {
            ...
            gl2.glMaterialfv(gl2.GL_FRONT_AND_BACK,gl2.GL_AMBIENT_AND_DIFFUSE,materials[3],3);
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        gl2.glLightModeli(GL2.GL_LIGHT_MODEL_COLOR_CONTROL,1);
